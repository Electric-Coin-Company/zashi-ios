            ...
            ScrollView {
                WithPerceptionTracking {
                    addressBlock(
                        ...
                        store.send(.requestTapped(store.unifiedAddress.redacted))
                    }
                    .padding(.top, 24)
                    ...
                    addressBlock(
                        ...
                        store.send(.requestTapped(store.transparentAddress.redacted))
                    }
#if DEBUG
                    if networkType == .testnet {
                        addressBlock(
                            ...
                            store.send(.requestTapped(store.saplingAddress.redacted))
                        }
                    }
#endif
