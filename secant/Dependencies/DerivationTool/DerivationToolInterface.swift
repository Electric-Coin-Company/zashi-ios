...
struct DerivationToolClient {
    ...
    /// - Parameter spendingKey: Spending key from which to derive Unified viewing key.
    /// - Returns: Derived viewing key.
    var deriveUnifiedViewingKeyFromSpendingKey: (UnifiedSpendingKey) throws -> UnifiedFullViewingKey
